      ...
      <section className="bg-gradient-to-br from-blue-50 to-indigo-100 py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            Simple Pricing. Scales as You Grow.
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Choose a ZERP365 plan that fits your business — flexible pricing for startups, SMEs, and enterprises.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md border-2 border-gray-200">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">Perfect for trying out ZERP365</p>
                ...
                <Link href="/pricing" className="bg-gray-600 text-white px-6 py-3 rounded-lg hover:bg-gray-700 transition-colors w-full block text-center">
                  Get Started Free
                </Link>
              </div>
            </div>
            ...
            <div className="bg-blue-50 p-8 rounded-lg shadow-md border-2 border-blue-300 relative">
              ...
              <div className="text-center">
                ...
                <Link href="/demo" className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors w-full block text-center">
                  Start Free Trial
                </Link>
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md border-2 border-gray-200">
              <div className="text-center">
                ...
                <Link href="/contact" className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors w-full block text-center">
                  Request a Quote
                </Link>
              </div>
            </div>
          ...
          <div className="text-center mt-12">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/pricing" className="border-2 border-blue-600 text-blue-600 px-8 py-3 rounded-lg hover:bg-blue-600 hover:text-white transition-colors text-lg font-semibold">
                Get Started Now
              </Link>
            </div>
          </div>
