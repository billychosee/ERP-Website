          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="animate-fade-in-up">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                <span className="text-[#8DC440]">Contact</span> Us
              </h1>
              <p className="text-xl mb-4 max-w-3xl">
                Let&apos;s Talk Business Efficiency
              </p>
              <p className="text-lg mb-8 max-w-2xl">
                Request a demo, ask a question, or explore partnership
                opportunities.
              </p>
            </div>
            ...
            >
              ...
              <p className="mt-4 text-sm">Or fill out the form below</p>
            </div>
          </div>
        </div>
      </section>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@smatechgroup.com</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+263 86 8800 8361</p>
                    <p className="text-sm text-gray-500 mt-1">
                      Mon-Fri, 8AM-6PM CAT
                    </p>
                  </div>
