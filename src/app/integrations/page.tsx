      ...
      <section className="bg-gradient-to-br from-blue-50 to-indigo-100 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Connect ZERP365 with your ecosystem — payment platforms, government tax systems, communication tools, analytics dashboards and more.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">Visa, EcoCash, OneMoney, ZimSwitch, InnBucks, SmatPay</p>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">WhatsApp & Email notifications</p>
              <ul className="text-sm text-gray-500 space-y-1">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">POS / eCommerce</h3>
              <p className="text-gray-600 mb-4">Real-time sync with POS and online stores</p>
              <ul className="text-sm text-gray-500 space-y-1">
          ...
          <div className="bg-gray-50 p-8 rounded-lg">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-6">APIs & Custom Integrations</h2>
            <p className="text-xl text-gray-600 text-center mb-8 max-w-3xl mx-auto">
              REST API for custom integrations and third-party extensions. Connect with any system that supports standard APIs.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <h4 className="text-lg font-semibold text-gray-900 mb-2">REST API</h4>
                <p className="text-gray-600">Full REST API access to all ZERP365 data and functions</p>
              </div>
              <div className="text-center">
                <h4 className="text-lg font-semibold text-gray-900 mb-2">Webhooks</h4>
                <p className="text-gray-600">Real-time event notifications for seamless integrations</p>
              </div>
              <div className="text-center">
                <h4 className="text-lg font-semibold text-gray-900 mb-2">OAuth 2.0</h4>
                <p className="text-gray-600">Secure authentication for third-party applications</p>
              </div>
            </div>
          </div>
